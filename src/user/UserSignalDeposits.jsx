...
const UserSignalDeposits = ({ user }) => {
  ...
  return (
    <>
      ...
      {isLoading && (
        <UserSignalDepositsStandard className="scrollbar-hide">
...
const UserSignalDepositsStandard = styled.div`
  padding-bottom: 24px;
  position: relative;
  max-width: 100%;
  /* overflow-y: visible; */
...
export default UserSignalDeposits;
