...
const SignalDepositHistory = ({ user }) => {
  ...
  return (
    <>
      ...
      {isLoading && (
        <SignalDepositHistoryStandard className="scrollbar-hide">
...
const SignalDepositHistoryStandard = styled.div`
  padding-bottom: 24px;
  position: relative;
  max-width: 100%;
  /* overflow-y: visible; */
  ...
  th {
    display: grid;
    grid-template-columns: 200px 120px 120px 120px 120px;
  ...
  @media screen and (max-width: 1300px) {
    th {
      display: grid;
      grid-template-columns: 180px 150px 120px 120px 120px 120px;
    }
...
export default SignalDepositHistory;
