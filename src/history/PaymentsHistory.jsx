...
const PaymentsHistory = ({ user }) => {
  ...
  return (
    <>
      ...
      {isLoading && (
        <PaymentsHistoryStandard className="scrollbar-hide">
...
const PaymentsHistoryStandard = styled.div`
  padding-bottom: 24px;
  position: relative;
  max-width: 100%;
  /* overflow-y: visible; */
  ...
  @media screen and (max-width: 1300px) {
    th {
      display: grid;
      grid-template-columns: 180px 150px 120px 120px 120px;
    }
