...
import "../styles/components/header-white.scss";
...
const HeaderWhite = () => {
  ...
  return (
    <div className="header__white__container">
      <div className="header__white__wrapper">
        <div className="header__white__left">
          <Link to="/">
            <img
              src="/logos/three.svg"
              alt="logo"
              className="header__white__logo"
            />
          </Link>

          <span className="header__white__links">
            {links.map((link) => (
              <p
                className="header__white__link"
                key={link}
        ...
        >
          {!mobileMenu && (
            <img
              ...
              alt="hamburger menu"
              className="header__white__hamburger"
            />
          )}
          {mobileMenu && (
            <img
        ...
        <div className="header__white__buttons">
          <button className="header__white__button__transparent">
            <a href="https://app.universaltrademarket.com">Log In</a>
          </button>
          <button className="header__white__button__blue">
      ...
      {mobileMenu && (
        <div className="menu__mobile__wrapper">
          <div className="menu__mobile">
            ...
            <div className="header__white__buttons__mobile">
              <button className="header__white__button__transparent">
                <a href="https://app.universaltrademarket.com">Log In</a>
              </button>
              <button className="header__white__button__blue">
